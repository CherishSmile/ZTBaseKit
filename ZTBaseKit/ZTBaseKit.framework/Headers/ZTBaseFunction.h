 ...
 */
void ZTShowProgressDialog(NSString * _Nullable showText,UIView * locationView,MBProgressHUDMode hudMode,NSTimeInterval delay,BOOL isUserAction);
 ...
 */
void ZTShowToast(NSString * _Nullable showText,UIView * locationView,NSTimeInterval delay,void(^ _Nullable CompleteHandler)(void));
...
/**
 ...
 @param CompleteHandler 消失后回调
 */
void ZTShowCustomToast(NSString * _Nullable showText,UIView *locationView,NSTimeInterval delay,void(^ _Nullable CompleteHandler)(void));
