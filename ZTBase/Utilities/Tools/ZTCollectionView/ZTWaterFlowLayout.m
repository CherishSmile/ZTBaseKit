...
/** 默认的列数*/
static const NSInteger ZTDefaultColumeCount = 2;
/** 默认的行数*/
static const NSInteger ZTDefaultRowCount = 5;

/** 每一列之间的间距*/
static const NSInteger ZTDefaultColumeMargin = 10;
/** 每一行之间的间距*/
static const CGFloat ZTDefaultRowMargin = 10;
/** 边缘之间的间距*/
static const UIEdgeInsets ZTDefaultEdgeInset = {10, 10, 10, 10};

///** 每一行之间的间距*/
//static const CGSize ZTDefaultHeaderSize = CGSizeMake(0, 66);
///** 每一行之间的间距*/
//static const CGSize ZTDefaultFooterSize = CGSizeMake(0, 66);
...
-(void)prepareLayout {
    ...
    if (self.flowLayoutStyle == ZTWaterFlowVerticalEqualWidth) {
    ...
    }else if (self.flowLayoutStyle == ZTWaterFlowHorizontalEqualHeight){
    ...
    }else if (self.flowLayoutStyle == ZTWaterFlowVerticalEqualHeight || self.flowLayoutStyle == ZTLineWaterFlow){
    ...
    }else if(self.flowLayoutStyle == ZTWaterFlowHorizontalGrid){
...
-(UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    }else if(self.flowLayoutStyle == ZTWaterFlowVerticalEqualHeight){
        
        attrs.frame = [self itemFrameOfVHWaterFlow:indexPath];
        
    }else if(self.flowLayoutStyle == ZTLineWaterFlow){
...
/*
 ...
 {
 if (self.flowLayoutStyle == ZTLineWaterFlow) {
