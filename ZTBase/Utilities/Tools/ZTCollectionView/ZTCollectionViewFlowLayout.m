...
#import "ZTCollectionViewFlowLayout.h"
...
@implementation ZTCollectionViewFlowLayout
...
- (void)setup
{
    [self registerClass:[ZTCollectionReusableView class] forDecorationViewOfKind:ZTCollectionViewSectionBackground];
}
...
- (void)prepareLayout
{
    ...
    if (!numberOfSections || ![delegate conformsToProtocol:@protocol(ZTCollectionViewDelegateFlowLayout)]) {
        return;
    }
    ...
    for (NSInteger section = 0; section < numberOfSections; section++) {
        ...
        // 2、定义
        ZTCollectionViewLayoutAttributes *attr = [ZTCollectionViewLayoutAttributes layoutAttributesForDecorationViewOfKind:ZTCollectionViewSectionBackground withIndexPath:[NSIndexPath indexPathForItem:0 inSection:section]];
