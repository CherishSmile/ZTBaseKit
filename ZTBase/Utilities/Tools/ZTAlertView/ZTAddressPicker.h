...
//******************************ZTAddressPicker******************************//
@protocol ZTAddressPickerDelegate <NSObject>
...
typedef void(^SureBtnClickReturnBlock)(NSString*province,NSString*city,NSString*area);

@interface ZTAddressPicker : UIView
...
/** 实现点击按钮代理*/
@property (nonatomic ,weak) id<ZTAddressPickerDelegate> delegate;

/** 实现点击按钮Blcok*/
@property (nonatomic ,copy) SureBtnClickReturnBlock returnBlock;
