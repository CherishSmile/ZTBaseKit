...
-(void)setUpUI{
    ...
    self.centerIV.contentMode = UIViewContentModeScaleAspectFit;
...
-(void)createTimer {
    ZTWeakObject *weakSelf = [ZTWeakObject weakObject:self];
    NSTimer *timer = [NSTimer scheduledTimerWithTimeInterval:self.autoScrollTimeInterval target:weakSelf selector:@selector(automaticScroll) userInfo:nil repeats:YES];
    _timer = timer;
